        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute top-10 -left-4 md:-left-10 bg-white p-2 md:p-4 rounded-xl border-3 md:border-4 border-neo-dark shadow-neo z-20 items-center gap-2 md:gap-3 animate-bounce hidden sm:flex" style={{animationDuration: '3s'}}>
              ...
              <div>
                <p className="font-bold text-sm md:text-base text-neo-dark">24/7 Care</p>
                <p className="text-xs md:text-sm text-neo-dark">Vet on call</p>
              </div>
            </div>
            ...
            <div className="absolute bottom-20 -right-4 md:-right-10 bg-neo-yellow p-2 md:p-4 rounded-xl border-3 md:border-4 border-neo-dark shadow-neo z-20 items-center gap-2 md:gap-3 animate-bounce hidden sm:flex" style={{animationDuration: '4s'}}>
              ...
              <div>
                <p className="font-bold text-sm md:text-base text-neo-dark">100+ Cats</p>
                <p className="text-xs md:text-sm text-neo-dark">Happy guests</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-neo-blue py-10 md:py-20 border-y-4 border-neo-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-black mb-2 md:mb-4 text-neo-dark">Our Services</h2>
            <p className="text-base md:text-xl font-medium text-neo-dark">Everything your cat needs while you are away!</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            <div className="neo-card p-8 bg-white text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-neo-dark">Cat Hotel</h3>
              <p className="font-medium text-neo-dark opacity-90">Premium boarding with AC, daily playground time, and constant supervision.</p>
            </div>
            ...
            <div className="neo-card p-8 bg-neo-yellow text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-neo-dark">Home Visit</h3>
              <p className="font-medium text-neo-dark opacity-90">We visit your home to feed, clean litter box, and play with your cat.</p>
            </div>
            ...
            <div className="neo-card p-8 bg-white text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-neo-dark">Grooming</h3>
              <p className="font-medium text-neo-dark opacity-90">Basic grooming, nail clipping, and ear cleaning during their stay.</p>
            </div>
          </div>
        </div>
      </section>
